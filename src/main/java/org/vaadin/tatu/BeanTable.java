...
public class BeanTable<T> extends HtmlComponent
        implements HasDataProvider<T>, HasSize, HasTheme {
    ...
    private void updateTooltips(Button first, Button previous, Button next,
            Button last) {
        if (i18n != null) {
            setTooltipText(first, i18n.getFirstPage());
            setTooltipText(last, i18n.getLastPage());
            setTooltipText(previous, i18n.getPreviousPage());
            setTooltipText(next, i18n.getNextPage());
            setTooltipText(menuButton, i18n.getMenuButton());
        }
    }
